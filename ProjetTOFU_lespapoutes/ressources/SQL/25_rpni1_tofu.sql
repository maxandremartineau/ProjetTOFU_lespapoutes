...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 04 nov. 2025 à 17:53
...
CREATE TABLE `couleurs` (
  ...
  `nom_fr` varchar(25) NOT NULL,
  `nom_en` varchar(25) NOT NULL,
...
INSERT INTO `couleurs` (`id`, `nom_fr`, `nom_en`, `hexadecimal`, `rgb`) VALUES
...
INSERT INTO `items` (`id`, `nom`, `echeance`, `est_complete`, `liste_id`) VALUES
(1, 'rigatoni', NULL, 0, 1),
...
CREATE TABLE `listes` (
  `id` int(10) UNSIGNED NOT NULL,
  `nom` varchar(55) NOT NULL COMMENT 'limite de 25 caractères',
...
INSERT INTO `listes` (`id`, `nom`, `couleur_id`, `utilisateur_id`) VALUES
(1, 'Épicerie', 3, 1),
(2, 'Devoirs', 12, 1),
